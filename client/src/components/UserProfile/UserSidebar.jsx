  ...
  return (
    <div className="usersidebar">
      ...
      {activepage === "changepassword" ? (
        ...
        <Link
          to={`/user/${uData?.username}/changepassword`}
          className="stylenone"
        >
          <div className="s1">
            <FaRegEye />
      ...
      {activepage === "yourbooks" ? (
        ...
        <Link to={`/user/${uData?.username}/yourbooks`} className="stylenone">
          <div className="s1">
            <GiSpellBook />
            <span>Your Favourite Books</span>
          </div>
        </Link>
      )}
      ...
      {isPremium &&
        (activepage === "youraddedbooks" ? (
          ...
          <Link
            to={`/user/${uData?.username}/youraddedbooks`}
            className="stylenone"
          >
            <div className="s1">
              <BiBookAdd size={25} />
      ...
      {activepage === "legalnotice" ? (
        ...
        <Link to={`/user/${uData?.username}/legalnotice`} className="stylenone">
          <div className="s1">
            <IoDocumentTextOutline />
            <span>Legal Notice</span>
          </div>
