      ...
      >
        <div className="relative justify-center text-3xl text-center bg-zinc-900 text-white h-16">
          ...
          <div>
            ...
            >
              <form className="relative w-[50%] h-[40rem] shadow-2xl rounded-xl flex flex-col gap-2 items-center justify-center border">
                ...
                <span className="text-4xl text-black mb-2">Edit Chapter</span>
                <input
                  type="text"
          ...
          >
            ...
            <div className="text-lg text-center text-white mb-2 mt-5 flex flex-col gap-2 ">
              Font
              <div className="flex gap-[23.0rem] px-4">
                <button
                ...
                <button
                  className="border-white border-2 px-20 grid text-2xl font-serif	 bold text-white text-center transition transform hover:-translate-y-0.5 active:-translate-y-2"
                  onClick={() => handleFontChange("serif")}
                >
                  Serif
                </button>
                <button
                  className="border-white border-2 px-16 grid text-2xl font-mono bold text-white text-center transition transform hover:-translate-y-0.5 active:-translate-y-2 "
